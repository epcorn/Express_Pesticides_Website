...
export default function ContactUsPage() {
  ...
  const address =
    "S - 5, 2nd Floor, Khira Industrial Estate, VM Bhargav Rd, Khira Nagar, Santacruz (West), Mumbai, 400054";

  const phone = "02261386600";
  const email = "epcorn@yahoo.in";
      ...
      <section className="relative py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 text-lg md:text-xl max-w-2xl mx-auto font-light leading-relaxed">
            Have a pest concern? Our experts are ready to provide the
            professional protection your property deserves.
          </p>
              ...
              <div className="grid gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <a
                    ...
                    className="flex items-center p-6 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-blue-50 transition-all group">
                  ...
                  <a
                    ...
                    className="flex items-center py-6 px-5 md:px-3 lg:px-2 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-blue-50 transition-all group">
                ...
                <div className="flex items-center p-6 bg-blue-50/50 rounded-2xl border border-blue-100">
                  ...
                  <p className="text-sm text-blue-900 font-medium italic">
                    Available Mon — Sat: 9:30 AM to 6:30 PM
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl border border-slate-100 relative overflow-hidden">
              ...
              <p className="text-slate-500 mb-10">
                Fill out the form below and an IPM specialist will contact you.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-4 bg-slate-50 border-transparent focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-100 rounded-xl transition-all outline-none text-slate-900 resize-none"></textarea>
                </div>
