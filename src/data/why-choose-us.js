export const whyChooseUsData = [
  {
    ...
    team: [
      ...
      },
      {
        ...
        desc: "With decades of combined experience, our professionals effectively identify pest problems and recommend the most suitable solutions.",
      },
      {
        title: "Customer-Focused Service",
        desc: "We prioritize safety, communication, punctuality, and customer satisfaction in every service visit.",
      },
    ],
    why: "Express, believes effective pest management should protect both people and the environment. Our eco-conscious approach combines Integrated Pest Management (IPM), responsible product selection, and precise application methods to deliver safe, sustainable, and long-lasting results. We help businesses and homeowners maintain healthier environments without compromising on performance.",
  },
  {
    ...
    team: [
      {
        ...
        desc: "We focus on prevention before treatment, reducing unnecessary pesticide use.",
      },
      {
        title: "Safe Products",
        desc: "We use approved formulations that are applied responsibly by trained professionals.",
      },
      {
        title: "Responsible Application",
        desc: "Precise application methods minimize exposure and maximize effectiveness.",
      },
      {
        title: "Sustainable Practices",
        desc: "Long-term pest prevention reduces repeated chemical applications.",
      },
    ],
    why: "Express, believes effective pest management should protect both people and the environment. Our eco-conscious approach combines Integrated Pest Management (IPM), responsible product selection, and precise application methods to deliver safe, sustainable, and long-lasting results. We help businesses and homeowners maintain healthier environments without compromising on performance.",
  },
    ...
    team: [
      {
        ...
        desc: "Instant access to inspection reports and treatment history.",
      },
      {
        title: "QR Code Tracking",
        desc: "Scan service points to view treatment records and inspection details.",
      },
      {
        title: "Smart Monitoring",
        desc: "Digital monitoring devices improve early pest detection.",
      },
      {
        title: "Data Analytics",
        desc: "Trend analysis helps prevent recurring infestations.",
      },
    ],
    why: "Innovation is at the heart of our pest management services. Express integrates digital reporting, QR code tracking, smart monitoring, and data-driven inspections to provide complete transparency and better control over pest management programs. Our technology helps customers make informed decisions while improving service efficiency and compliance.",
  },
  {
    ...
    team: [
      {
        ...
        desc: "Comprehensive inspection to identify pest risks.",
      },
      {
        title: "Risk Analysis",
        desc: "Evaluate infestation levels and environmental factors.",
      },
      {
        title: "Customized Strategy",
        desc: "Develop treatment plans specific to your needs.",
      },
      {
        title: "Ongoing Monitoring",
        desc: "Regular inspections ensure continuous protection.",
      },
    ],
    why: "No two properties face the same pest challenges. That's why EPCORN develops customized pest management programs based on your industry, facility layout, operational requirements, and pest risks. Our tailored solutions maximize effectiveness while minimizing disruption to your business or home.",
  },
  {
